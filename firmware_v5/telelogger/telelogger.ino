...
TEDACompress teda_speed;
TEDACompress teda_rpm;
TEDACompress teda_intake_temp;
TEDACompress teda_throttle;
TEDACompress teda_engine_load;
TEDACompress teda_relative_throttle_pos;
TEDACompress teda_fuel_level;
